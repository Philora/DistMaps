...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    Button btnCalc;
    TextView txtDistance, txtDuration, txtDB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapsDatabase = Room.databaseBuilder(this, MapsDatabase.class, "maps-db")
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, jsonURL, null, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    for(Maps map : listMaps){
                        ...
                        Log.d(TAG, "Read DB after inserting " + mapsInfo);
                        txtDB.setText(mapsInfo);
                    }
